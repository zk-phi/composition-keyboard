...
「ボトムプレート下」に 1mm 薄い 2mm のものを使うこともできます。

打面を 1mm 下げられるほか、デザイン的にもミドルプレートを中心に上下対称となって綺麗に見えます。

ただし、 Pro Micro に取り付けたコンスルー（ピンヘッダ）の足がケースをはみ出してしまうため、足をカットする、または十分な高さのゴムクッションを使うなどして、机に触れてしまうことがないよう工夫する必要があります。
